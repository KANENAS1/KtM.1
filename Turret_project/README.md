...
1. Copy this folder to Pi via USB or SCP (e.g., scp -r k\_turret\_project pi@your-pi-ip:/home/pi/)
2. On Pi: cd k\_turret\_project
3. Install: sudo pip3 install -r requirements.txt
4. Run: sudo python3 k\_turret.py
...
4. Open Folder on Pi: /home/pi/k\_turret\_project
5. Edit code, run in VS Code terminal: sudo python3 k\_turret.py
